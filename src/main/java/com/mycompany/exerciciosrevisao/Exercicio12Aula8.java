 ...
 * @author aluno
 */
public class Exercicio12Aula8 {

    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) {
        /* Crie um método que receba dois parâmetros de números de ponto
flutuante (a e b) correspondendo a valores dos catetos de um triângulo retângulo e retorne
